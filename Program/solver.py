...
from scoring import match_with_local_brightness_tiebreak
    ...
    for beta in betaGrid:
        ...
        for gamma in gammaList:
            for alpha in alphaGrid:
                ...
                score, matched_catalog_indices, matched_image_indices, distances_pix, rms_pix = match_with_local_brightness_tiebreak(imgXY, tree, predictedXY, sourceFluxes, catalogMag, pixelTolerance)
                if score > best["score"]:
                    best = {
                        "score": score,
                        "alpha": alpha,
