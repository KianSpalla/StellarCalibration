...
image_path = Path(r"C:\Users\spall\Desktop\GONet\Testing Images\256_251029_204008_1761770474.jpg")
go = GONetFile.from_file(image_path)
go.remove_overscan()
img_gray = go.green
#img_xy = None          # TODO: np.array shape (N,2)
img_xy = compute_img_centroids(image_path, N=5.0, top_k=300)
#cat_xy_unit = None     # TODO: np.array shape (M,2)
cat_xy_unit = compute_cat_unit_coords(image_path, radius_deg=60.0, gmax=8.0, top_m=1000)
#cx, cy = None, None    # TODO: floats
cx, cy = img_gray.data.shape[1]/2, img_gray.data.shape[0]/2  # Example: center of image
#R_pix = None           # TODO: float
R_pix =  img_gray.data.shape[0]/2  # Example: set to half image height
